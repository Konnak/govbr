tinymce.addI18n("pt_BR", {
    ...
    "Inline": "Inline",
    "Blocks": "Blocos",
    "Paste is now in plain text mode. Contents will now be pasted as plain text until you toggle this option off.": "Colar agora está em modo texto plano. O conteúdo será colado como texto plano até você desativar esta opção.",
    "Fonts": "Fontes",
    ...
    "Help": "Ajuda",
    "Address": "Endereço",
    "Focus to menubar": "Focar na barra de menu",
    "Focus to toolbar": "Focar na barra de ferramentas",
    "Focus to element path": "Focar no caminho do elemento",
    "Focus to contextual toolbar": "Focar na barra de ferramentas contextual",
    ...
    "Find (if searchreplace plugin activated)": "Localizar (se o plugin de buscar e substituir estiver ativado)",
